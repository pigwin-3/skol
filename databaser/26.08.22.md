...
## oppgave 6
´´´sql
SELECT data.arsmodel, data.brand, elev.Fornavn, elev.Etternavn, elev.ElevID FROM elev INNER JOIN data ON elev.data = data.dataid WHERE Fornavn IN ('Martin', 'Hanna');
´´´
